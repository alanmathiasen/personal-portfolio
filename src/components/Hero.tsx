...
const Hero = () => (
  <div className="flex flex-wrap m-auto justify-center md:justify-start md:py-24 relative overflow-hidden md:h-[70vh] h-[50vh]">
    <div id="home"></div>
    ...
    <div className="self-center z-[2] md:w-8/12 m-auto">
      <div className=" text-center md:text-left md:w-[60%]">
        <div className="font-bold text-theme text-5xl md:text-6xl lg:text-6xl mb-2">
